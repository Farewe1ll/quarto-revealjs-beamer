...
以 CambridgeUS 为蓝本的白底酒红外观，适配现代浏览器演示。

## 经典报告版式 {data-subsection="配色"}

### 正式、克制、适合学术报告与答辩

这套主题默认显示红灰双色的 section / subsection 导航页眉，标题块不带底色，配合三段式 footline 与扁平列表符号。
...
使用 `beamer-variant: madrid` 即可切换为 Madrid 深蓝配色。
:::
...
- `beamer-variant: cambridgeus`：经典的酒红色报告风格，默认显示章节页眉
- `beamer-variant: madrid`：沉稳的蓝色学术风格，无页眉布局
- frame、作者、标题、日期和页码自动进入信息栏，页眉可通过 `beamer-secheader` 覆盖
